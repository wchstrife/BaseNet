...
class GoogleNet(nn.Module):
    ...
    def __init__(self, num_classes = 1000, aux_logits = True, transform_input = False, init_weight = None, blocks = None):
...
class Inception(nn.Module):
    ...
    def forward(self, x):
        ...
        return torch.cat(outputs, 1)        # Channel维度上concat到一起
...
class BasicConv2d(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, **kwargs):
        ...
        self.conv = nn.Conv2d(in_channels, out_channels, bias=False, **kwargs)              ## 卷积到底需不要bias
